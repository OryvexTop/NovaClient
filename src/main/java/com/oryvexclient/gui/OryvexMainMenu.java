...
public class OryvexMainMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(5, centerX, startY + 50, BUTTON_WIDTH, BUTTON_HEIGHT, "Alt Manager"));
        this.buttonList.add(new GuiButton(3, centerX, startY + 75, BUTTON_WIDTH, BUTTON_HEIGHT, "Settings"));
        this.buttonList.add(new GuiButton(4, centerX, startY + 100, BUTTON_WIDTH, BUTTON_HEIGHT, "Quit Game"));
    }

    @Override
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        drawDefaultBackground();
        drawCenteredString(this.fontRendererObj, "ORYVEX CLIENT", this.width / 2, this.height / 2 - 90, ACCENT_COLOR);
        drawCenteredString(this.fontRendererObj, "v1.0", this.width / 2, this.height / 2 - 70, 0xAAAAAA);
